...
class ModelTraining:
    ...
    def load_data(self):
        try:
            ...
            logger.info(f"Error while loading...")
    ...
    def train_model(self, X_train,y_train):
        try:
            ...
            logger.info(f"Error while model training...")
            raise CustomException("Error while model training")
    ...
    def evaluate_model(self, X_test, y_test):
        try:
            ...
            confusion_matrix_path  = os.path.join(self.model_path, "connfusion_matrix.png")
            plt.savefig(confusion_matrix_path)
            plt.close()
            
        except Exception as e:
            logger.info(f"Error while evaluation...")
            raise CustomException("Error while evaluation")
